...
public class Picture extends SimplePicture 
{
  ...
  public void grayscale(){
    ...
    for (Pixel[] rowArray : pixels)
    {
      for (Pixel pixelObj : rowArray)
      {
        pixelObj.setRed((pixelObj.getRed()+pixelObj.getGreen())/3);
        pixelObj.setGreen((pixelObj.getRed()+pixelObj.getGreen())/3);
        pixelObj.setBlue((pixelObj.getRed()+pixelObj.getGreen())/3);
      }
    }
  }
